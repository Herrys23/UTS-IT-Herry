        ...
        <div class="row justify-content-center">
            <div class="col-sm-8 mt-5">
                <div class="card mt-3 p-3">
                    <form action="/store" method="POST" class="user" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea name='description' value="{{old('description')}}" class="form-control form-control-user rows=" 4" id="exampleFirstName" placeholder=" Write About User"></textarea>
                            @error('description')
                            <p class="m-0 small alert alert-danger shadow-sm">{{$message}}</p>
                            @enderror
                        </div>
