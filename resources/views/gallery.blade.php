                    ...
                    <div id="youtubeCarousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <iframe class="d-block w-100" width="800" height="400" src="https://www.youtube.com/embed/Oo7HNldpmPs" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="carousel-item">
                                <iframe class="d-block w-100" width="800" height="400" src="https://youtube.com/embed/pylOuKGytfE" frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="carousel-item">
                                <iframe class="d-block w-100" width="800" height="400" src="https://youtube.com/embed/MQK_70DcrCw" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
