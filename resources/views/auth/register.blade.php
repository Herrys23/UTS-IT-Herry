...
<style>
  .bg-register-imageLokal {
    /* Ganti URL dengan path gambar yang diinginkan */
    /*background-image: url('path/to/your/image.jpg');*/
     background-image: url('assets/images/MrInc.jpg.jpg');
    /* Ganti nilai-nilai berikut sesuai kebutuhan Anda */
